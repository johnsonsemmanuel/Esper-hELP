...
function Calendar({
  ...
  const defaultClassNames = {
    ...
    day_button:
      ...
      "data-[disabled]:opacity-40 data-[disabled]:cursor-not-allowed data-[disabled]:hover:bg-transparent data-[disabled]:hover:text-muted-foreground/40",
    day: "text-center",
    range_start:
  ...
  const mergedClassNames: Record<string, string> = Object.keys(
    defaultClassNames
  ).reduce(
    (acc, key) => {
