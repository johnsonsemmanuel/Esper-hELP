...
function NavigationMenuTrigger({
  ...
  return (
    <NavigationMenuPrimitive.Trigger
      ...
      className={cn(
        "group inline-flex w-max items-center justify-center rounded-full px-3 py-1.5 text-sm font-medium transition-colors outline-none hover:bg-pink-50 hover:text-pink-600 focus-visible:ring-2 focus-visible:ring-pink-500/50 focus-visible:outline-none data-[state=open]:bg-pink-50 data-[state=open]:text-pink-600",
        className,
      )}
      {...props}
    >
